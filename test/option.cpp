...
BOOST_AUTO_TEST_CASE(Option_WhenNoneIsSomeIsFalse)
{
    auto option = TinyFp::Option<int>::None();
    BOOST_CHECK(option.IsSome() == false);
}

BOOST_AUTO_TEST_CASE(Option_WhenSomeIsSomeIsTrue)
{
    int test = 10;
...
BOOST_AUTO_TEST_CASE(Option_WhenSomeAndOrElseReturnValue)
{
    int test = 10;
...
BOOST_AUTO_TEST_CASE(Option_WhenNoneAndOrElseReturnDefault)
{
    int test = 10;
...
BOOST_AUTO_TEST_CASE(Option_WhenSomeAndOrElseReturnValueReference)
{
...
BOOST_AUTO_TEST_CASE(Option_WhenNoneAndOrElseReturnDefaultReference_)
{
    FakeClass* test = NULL;
    auto mapped = createOption(test);
    auto test1 = mapped.OrElse<FakeClass>([]() { return FakeClass(100); });
...
BOOST_AUTO_TEST_CASE(Option_WhenNoneAndOrElseReturnDefaultReference)
{
    auto test = FakeClass(10);
...
BOOST_AUTO_TEST_CASE(Option_WhenNoneAndMapSomeIsFalseReference)
{
    auto test = FakeClass(10);
    auto mapped = TinyFp::Option<FakeClass>::None()
...
BOOST_AUTO_TEST_CASE(Option_WhenSomeAndMapSomeIsTrueReference)
{
    auto test = FakeClass(10);
    auto mapped = createOption(&test)
                    .Map<FakeClassMapped>([](FakeClass& value) { return FakeClassMapped(value.value*20); } );
...
BOOST_AUTO_TEST_CASE(Option_WhenNoneAndMatch_ReturnNone)
{
    auto mapped = TinyFp::Option<FakeClass>::None()
...
BOOST_AUTO_TEST_CASE(Option_WhenSomeAndMatch_ReturnSome)
{
    auto test = FakeClass(10);
    auto mapped = TinyFp::Option<FakeClass>::Some(test)
                    .Match<FakeClassMapped>(
...
BOOST_AUTO_TEST_CASE(Option_WhenNoneAndMatch_ReturnNone_WithScalar)
{
    auto mapped = TinyFp::Option<FakeClass>::None()
                    .Match<int>(
...
BOOST_AUTO_TEST_CASE(Option_WhenSomeAndMatch_ReturnSome_WithScalar)
{
